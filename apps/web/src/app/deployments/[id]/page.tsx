      ...
      toast({
        ...
        description:
          targetUserId === user.uid
            ? "Connect at least one Instagram, YouTube, or TikTok account in Insights before securing a deployment — brands need verified reach."
            : "This talent needs at least one connected Instagram, YouTube, or TikTok account in Insights before you can secure a deployment for them.",
        variant: "destructive",
        action: (
          <Button variant="outline" size="sm" asChild>
