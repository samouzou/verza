'use server';
/**
 * @fileOverview Extracts key contract details (brand, amount, due date, and common terms) from contract documents using an LLM.
 *
...
const prompt = ai.definePrompt({
  ...
  - extractedTerms: An object containing other relevant terms. Focus on:
    ...
    If specific terms are not clearly present, their respective fields in extractedTerms can be empty or the extractedTerms object itself can be empty.
