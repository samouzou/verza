...
export function UploadContractDialog() {
  ...
  const handleSaveContract = async () => {
    ...
    try {
      ...
      const currentSummary = summary || { summary: contractTextForSave.trim() ? "Summary not generated by AI." : "No summary available." };
      ...
      const contractDataForFirestore: Omit<Contract, 'id' | 'createdAt' | 'updatedAt'> & { createdAt: any, updatedAt: any } = {
        ...
        fileName: fileName.trim() || (selectedFile ? selectedFile.name : (contractTextForSave.trim() ? "Pasted Contract" : "Untitled Contract")),
