    ...
    for (const doc of contractsToRemind) {
      ...
      try {
        ...
        const htmlContent = `
            ...
            <head>
              ...
              <style>
                ...
                .container { max-width: 600px; margin: auto; background-color: #ffffff; border: 1px solid #e2e2e2; border-radius: 8px; overflow: hidden; }
                ...
                .button { background-color: #EF4444; color: #ffffff; padding: 14px 28px; text-decoration: none; border-radius: 5px; font-size: 16px; font-weight: 500; }
            ...
            <body>
              <div class="container">
                ...
                <div class="content">
                  <p>Hello,</p>
                  <p>This is a reminder that your payment of <span class="bold">$${contract.amount.toLocaleString()}</span> for the project <span class="bold">'${contract.projectName || contract.brand}'</span> is now overdue.</p>
                  <p>To keep things on track, please process your payment at your earliest convenience. You can pay securely via the link below:</p>
        ...
        const msg = {
          ...
          text: `This is a reminder that your payment of $${contract.amount} for contract ${contract.projectName || contractId} is overdue. Please process your payment as soon as possible. Pay now: ${paymentLink}`,
          html: htmlContent,
  ...
  try {
    ...
    for (const doc of contractsToRemind) {
      ...
      try {
        ...
        const creator = creatorDoc.data() as UserProfileFirestoreData | undefined;
        const creatorName = creator?.displayName || "The Creator";
        const dueDateFormatted = new Date(contract.dueDate + 'T00:00:00').toLocaleDateString("en-US", { year: "numeric", month: "long", day: "numeric" });
        const appUrl = process.env.APP_URL || "http://localhost:9002";
        const paymentLink = `${appUrl}/pay/contract/${contractId}`;
        const verzaLogoUrl = `${appUrl}/verza-icon.svg`;
        ...
        const htmlContent = `
            ...
            <head>
              ...
              <style>
                ...
                .bold { font-weight: 600; }
                .button-container { text-align: center; margin: 30px 0; }
                .button { background-color: #3b82f6; color: #ffffff; padding: 14px 28px; text-decoration: none; border-radius: 5px; font-size: 16px; font-weight: 500; }
                .footer { background-color: #f8f8f8; color: #777; padding: 20px; text-align: center; font-size: 12px; }
                .footer img { vertical-align: middle; height: 16px; margin-left: 5px; }
              </style>
            </head>
            <body>
              <div class="container">
                ...
                <div class="content">
                  <p>Hello,</p>
                  <p>This is a friendly reminder that your payment of <span class="bold">$${contract.amount.toLocaleString()}</span> for the project <span class="bold">'${contract.projectName || contract.brand}'</span> is due on <span class="bold">${dueDateFormatted}</span>.</p>
        ...
        const msg = {
          ...
          text: `This is a reminder that your payment of $${contract.amount} for contract ${contract.projectName || contractId} is due on ${dueDateFormatted}. Pay here: ${paymentLink}`,
          html: htmlContent,
          customArgs: { contractId },
        };
