...
const prompt = ai.definePrompt({
  ...
  2.  **decisionMakers**: Identify the likely job *titles* of marketing decision-makers. Do NOT invent names. Focus on roles like "CMO", "Head of Brand", "Influencer Marketing Manager", "Social Media Director".
  3.  **currentVibe**: Summarize the brand's current marketing aesthetic, voice, and target audience. What is their vibe? (e.g., "Minimalist and eco-conscious," "Edgy and youth-focused," "Luxurious and aspirational").
  4.  **pitchHooks**: Generate exactly three specific and creative pitch hooks a content creator could use to sell them User-Generated Content (UGC) or an influencer partnership. These should be tailored to the brand's vibe and products.
  `,
});
