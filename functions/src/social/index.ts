...
export const syncInstagramStats = onCall(async (request) => {
  ...
  try {
    ...
    if (!pageWithIg) {
      throw new HttpsError("not-found", "No Instagram Business account found linked to your Facebook Pages. Ensure your IG account is professional and linked to a Page.");
    }
